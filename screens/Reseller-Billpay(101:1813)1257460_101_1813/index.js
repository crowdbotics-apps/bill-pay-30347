...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_1814} />
      <View style={styles.View_101_1815}>
        <View style={styles.View_101_1816}>
          <View style={styles.View_101_1817}>
            <Text style={styles.Text_101_1817}>12:30 PM</Text>
          </View>
        </View>
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_101_1818}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1823}
        />
        <View style={styles.View_101_1827}>
          <View style={styles.View_101_1828} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
            }}
            style={styles.ImageBackground_101_1829}
          />
          <View style={styles.View_101_1830} />
        </View>
      </View>
      <View style={styles.View_101_1831}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/09ad/ce98/4bbd1224c4db2ef5c083f3d3abaa3aaa"
          }}
          style={styles.ImageBackground_101_1832}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1840}
        />
      </View>
      <View style={styles.View_101_1844}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/41d1/70e9/83a95f70b7cab3f2d6ef562c17767f49"
          }}
          style={styles.ImageBackground_101_1845}
        />
      </View>
      <View style={styles.View_101_1847}>
        <View style={styles.View_101_1848} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/0448/a657/9adf2331b7a3e9ae49071612b15bf0d2"
          }}
          style={styles.ImageBackground_101_1849}
        />
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_1974}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_1975}
      />
      <View style={styles.View_101_1980} />
      <View style={styles.View_101_1981}>
        <Text style={styles.Text_101_1981}>Purchased Services</Text>
      </View>
      <View style={styles.View_101_1982}>
        <Text style={styles.Text_101_1982}>Game</Text>
      </View>
      <View style={styles.View_101_1983} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d898/5fd4/ee8510cb01b69730fba665c4f76f04cd"
        }}
        style={styles.ImageBackground_101_1984}
      />
      <View style={styles.View_101_1985} />
      <View style={styles.View_101_1986}>
        <Text style={styles.Text_101_1986}>Balance : 500,000 Ks</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_1987}
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_1988}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2960"))
        }
      >
        <View style={styles.View_101_1989}>
          <View style={styles.View_101_1990} />
          <View style={styles.View_101_1991}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f220/36d2/89009d3834d3d6bff3fb187561e11cb6"
              }}
              style={styles.ImageBackground_101_1992}
            />
          </View>
        </View>
        <View style={styles.View_101_2000}>
          <Text style={styles.Text_101_2000}>Bill Pay</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_101_2001}>
        <View style={styles.View_101_2002}>
          <Text style={styles.Text_101_2002}>History</Text>
        </View>
        <View style={styles.View_101_2003}>
          <View style={styles.View_101_2004} />
          <View style={styles.View_101_2005}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1ea4/ef0a/c96c52bc099c1a072d4fbc09df6ccb01"
              }}
              style={styles.ImageBackground_101_2006}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_2013}>
        <Text style={styles.Text_101_2013}>Scan</Text>
      </View>
      <View style={styles.View_101_2014}>
        <View style={styles.View_101_2015}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d0be/9be8/ac76efebb1777d4e22ff0b8f5c91339e"
            }}
            style={styles.ImageBackground_101_2016}
          />
          <View style={styles.View_101_2017}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f253/bb3a/059062f88b980f9841bdbc4fab9ca70c"
              }}
              style={styles.ImageBackground_101_2018}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_101_2023}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_2024}>
        <View style={styles.View_101_2025} />
        <View style={styles.View_101_2026}>
          <View style={styles.View_101_2027}>
            <Text style={styles.Text_101_2027}>Home</Text>
          </View>
          <View style={styles.View_101_2028}>
            <View
              source={{ uri: "null" }}
              style={styles.View_I101_2028_101_9}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_I101_2028_101_10}
            />
          </View>
        </View>
        <View style={styles.View_101_2029}>
          <View style={styles.View_101_2030}>
            <Text style={styles.Text_101_2030}>Packages</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_2031}
          />
        </View>
        <View style={styles.View_101_2032}>
          <View style={styles.View_101_2033}>
            <Text style={styles.Text_101_2033}>Account</Text>
          </View>
          <View style={styles.View_101_2034}>
            <View
              source={{ uri: "null" }}
              style={styles.View_I101_2034_101_17}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_I101_2034_101_18}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_2035}>
        <View style={styles.View_101_2036} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4865/cd2d/008c02bb5683c2814b6da62aad4c3677"
          }}
          style={styles.ImageBackground_101_2037}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_2038}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_2039}
        />
        <View style={styles.View_101_2040}>
          <Text style={styles.Text_101_2040}>Internet</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_2041}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_2042}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_2043}
        />
        <View style={styles.View_101_2044}>
          <View style={styles.View_101_2045} />
          <View style={styles.View_101_2046}>
            <Text style={styles.Text_101_2046}>Buy</Text>
          </View>
        </View>
        <View style={styles.View_101_2047}>
          <View style={styles.View_101_2048} />
          <View style={styles.View_101_2049}>
            <Text style={styles.Text_101_2049}>Buy</Text>
          </View>
        </View>
        <View style={styles.View_101_2050}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6481/1904/bbc26699cc8c4c974bcb6da5543f548f"
            }}
            style={styles.ImageBackground_101_2051}
          />
          <View style={styles.View_101_2052}>
            <Text style={styles.Text_101_2052}>B</Text>
          </View>
        </View>
        <View style={styles.View_101_2053}>
          <View style={styles.View_101_2054}>
            <Text style={styles.Text_101_2054}>Active Packs :</Text>
          </View>
          <View style={styles.View_101_2055}>
            <Text style={styles.Text_101_2055}>3</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_2056}
          />
        </View>
        <View style={styles.View_101_2057}>
          <View style={styles.View_101_2058}>
            <Text style={styles.Text_101_2058}>Recommendations</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_2059}
          />
        </View>
        <View style={styles.View_101_2060}>
          <View style={styles.View_101_2061}>
            <Text style={styles.Text_101_2061}>Maximum Speed</Text>
          </View>
          <View style={styles.View_101_2062}>
            <Text style={styles.Text_101_2062}>10Mbps</Text>
          </View>
          <View style={styles.View_101_2063}>
            <View style={styles.View_101_2064} />
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/292a/12fc/ed5ff0e8613e8031115409fdad12ca35"
              }}
              style={styles.ImageBackground_101_2065}
            />
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I101_2028_101_10: {
    flexGrow: 1,
  ...
  ImageBackground_I101_2034_101_18: {
    flexGrow: 1,
