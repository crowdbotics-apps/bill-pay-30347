...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2149} />
      <View style={styles.View_101_2155} />
      <View style={styles.View_101_2156} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/59c1/7ff4/ea270c4ff0f509de34fc54318bea1ebd"
        }}
        style={styles.ImageBackground_101_2157}
      />
      <View style={styles.View_101_2158}>
        <View style={styles.View_101_2159}>
          <Text style={styles.Text_101_2159}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2160}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2165}
      />
      <View style={styles.View_101_2169}>
        <View style={styles.View_101_2170} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2171}
        />
        <View style={styles.View_101_2172} />
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2173}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2174}
      />
      <View style={styles.View_101_2175}>
        <Text style={styles.Text_101_2175}>Customer Name</Text>
      </View>
      <View style={styles.View_101_2176}>
        <Text style={styles.Text_101_2176}>Meter No.</Text>
      </View>
      <View style={styles.View_101_2177}>
        <Text style={styles.Text_101_2177}>Barcode.</Text>
      </View>
      <View style={styles.View_101_2178}>
        <Text style={styles.Text_101_2178}>Su Su</Text>
      </View>
      <View style={styles.View_101_2179}>
        <Text style={styles.Text_101_2179}>M-111009</Text>
      </View>
      <View style={styles.View_101_2180}>
        <Text style={styles.Text_101_2180}>281-001066</Text>
      </View>
      <View style={styles.View_101_2181}>
        <Text style={styles.Text_101_2181}>Service Month</Text>
      </View>
      <View style={styles.View_101_2182}>
        <Text style={styles.Text_101_2182}>Township</Text>
      </View>
      <View style={styles.View_101_2183}>
        <Text style={styles.Text_101_2183}>Bill Amount</Text>
      </View>
      <View style={styles.View_101_2184}>
        <Text style={styles.Text_101_2184}>Service fees</Text>
      </View>
      <View style={styles.View_101_2185}>
        <Text style={styles.Text_101_2185}>36,400 Ks</Text>
      </View>
      <View style={styles.View_101_2186}>
        <Text style={styles.Text_101_2186}>March, 2020</Text>
      </View>
      <View style={styles.View_101_2187}>
        <Text style={styles.Text_101_2187}>Mayangone</Text>
      </View>
      <View style={styles.View_101_2188}>
        <Text style={styles.Text_101_2188}>36,200 Ks</Text>
      </View>
      <View style={styles.View_101_2189}>
        <Text style={styles.Text_101_2189}>200 Ks</Text>
      </View>
      <View style={styles.View_101_2190}>
        <Text style={styles.Text_101_2190}>Total Amount</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2191}
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2192}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2198"))
        }
      >
        <View style={styles.View_101_2193} />
        <View style={styles.View_101_2194}>
          <Text style={styles.Text_101_2194}>Pay</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_101_2195}>
        <Text style={styles.Text_101_2195}>Bill Payment Detail</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2196}
      />
      <View style={styles.View_101_2197}>
        <Text style={styles.Text_101_2197}>Electricity Bill (Yangon)</Text>
      </View>
    </ScrollView>
  )
}
