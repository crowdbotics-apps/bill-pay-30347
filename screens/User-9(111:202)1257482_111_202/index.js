...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_111_131}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/8af3/4ea1/b17ac1bf50b9ebaf26bd313579252edf"
          }}
          style={styles.ImageBackground_111_132}
        />
        <View style={styles.View_111_133} />
        <View style={styles.View_111_134}>
          <View style={styles.View_111_135} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/03a9/8428/eb51e3ccd29e8e33d2101563b755b1b8"
            }}
            style={styles.ImageBackground_111_136}
          />
        </View>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_111_204}
        onPress={() =>
