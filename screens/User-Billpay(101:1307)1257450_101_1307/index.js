...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_1308} />
      <View style={styles.View_101_1309} />
      <View style={styles.View_101_1310} />
      <View style={styles.View_101_1311}>
        <View style={styles.View_101_1312}>
          <Text style={styles.Text_101_1312}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_1313}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_1318}
      />
      <View style={styles.View_101_1322}>
        <View style={styles.View_101_1323} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_1324}
        />
        <View style={styles.View_101_1325} />
      </View>
      <View style={styles.View_101_1326}>
        <Text style={styles.Text_101_1326}>Balance : 50,000 Ks</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_1327}
      />
      <View style={styles.View_101_1328}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/09ad/ce98/4bbd1224c4db2ef5c083f3d3abaa3aaa"
          }}
          style={styles.ImageBackground_101_1329}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1337}
        />
      </View>
      <View style={styles.View_101_1341}>
        <View style={styles.View_101_1342}>
          <View style={styles.View_101_1343}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/50a1/6d32/890dd86583bf53cfa3dc87ccd16aac50"
              }}
              style={styles.ImageBackground_101_1344}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_101_1347}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_101_1349}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_1350}>
        <Text style={styles.Text_101_1350}>Top up</Text>
      </View>
      <View style={styles.View_101_1351}>
        <Text style={styles.Text_101_1351}>Scan</Text>
      </View>
      <View style={styles.View_101_1352}>
        <View style={styles.View_101_1353}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d0be/9be8/ac76efebb1777d4e22ff0b8f5c91339e"
            }}
            style={styles.ImageBackground_101_1354}
          />
          <View style={styles.View_101_1355}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f253/bb3a/059062f88b980f9841bdbc4fab9ca70c"
              }}
              style={styles.ImageBackground_101_1356}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_101_1361}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_1362}>
        <View style={styles.View_101_1363} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4865/cd2d/008c02bb5683c2814b6da62aad4c3677"
          }}
          style={styles.ImageBackground_101_1364}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1365}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1366}
        />
        <View style={styles.View_101_1367}>
          <Text style={styles.Text_101_1367}>Internet</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1368}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1369}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_101_1370}
        />
        <View style={styles.View_101_1371}>
          <View style={styles.View_101_1372} />
          <View style={styles.View_101_1373}>
            <Text style={styles.Text_101_1373}>Buy</Text>
          </View>
        </View>
        <View style={styles.View_101_1374}>
          <View style={styles.View_101_1375} />
          <View style={styles.View_101_1376}>
            <Text style={styles.Text_101_1376}>Buy</Text>
          </View>
        </View>
        <View style={styles.View_101_1377}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6481/1904/bbc26699cc8c4c974bcb6da5543f548f"
            }}
            style={styles.ImageBackground_101_1378}
          />
          <View style={styles.View_101_1379}>
            <Text style={styles.Text_101_1379}>B</Text>
          </View>
        </View>
        <View style={styles.View_101_1380}>
          <View style={styles.View_101_1381}>
            <Text style={styles.Text_101_1381}>Active Packs :</Text>
          </View>
          <View style={styles.View_101_1382}>
            <Text style={styles.Text_101_1382}>3</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_1383}
          />
        </View>
        <View style={styles.View_101_1384}>
          <View style={styles.View_101_1385}>
            <Text style={styles.Text_101_1385}>Recommendations</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_1386}
          />
        </View>
        <View style={styles.View_101_1387}>
          <View style={styles.View_101_1388}>
            <Text style={styles.Text_101_1388}>Maximum Speed</Text>
          </View>
          <View style={styles.View_101_1389}>
            <Text style={styles.Text_101_1389}>10Mbps</Text>
          </View>
          <View style={styles.View_101_1390}>
            <View style={styles.View_101_1391} />
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/292a/12fc/ed5ff0e8613e8031115409fdad12ca35"
              }}
              style={styles.ImageBackground_101_1392}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_1393}>
        <View style={styles.View_101_1394} />
        <View style={styles.View_101_1395}>
          <View style={styles.View_101_1396}>
            <Text style={styles.Text_101_1396}>Home</Text>
          </View>
          <View style={styles.View_101_1397}>
            <View
              source={{ uri: "null" }}
              style={styles.View_I101_1397_101_9}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_I101_1397_101_10}
            />
          </View>
        </View>
        <View style={styles.View_101_1398}>
          <View style={styles.View_101_1399}>
            <Text style={styles.Text_101_1399}>Packages</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_101_1400}
          />
        </View>
        <View style={styles.View_101_1401}>
          <View style={styles.View_101_1402}>
            <Text style={styles.Text_101_1402}>Account</Text>
          </View>
          <View style={styles.View_101_1403}>
            <View
              source={{ uri: "null" }}
              style={styles.View_I101_1403_101_17}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_I101_1403_101_18}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_101_1404}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/41d1/70e9/83a95f70b7cab3f2d6ef562c17767f49"
          }}
          style={styles.ImageBackground_101_1405}
        />
      </View>
      <View style={styles.View_101_1407}>
        <View style={styles.View_101_1408} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/0448/a657/9adf2331b7a3e9ae49071612b15bf0d2"
          }}
          style={styles.ImageBackground_101_1409}
        />
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_1534}
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_1535}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2260"))
        }
      >
        <View style={styles.View_101_1536}>
          <View style={styles.View_101_1537} />
          <View style={styles.View_101_1538}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f220/36d2/89009d3834d3d6bff3fb187561e11cb6"
              }}
              style={styles.ImageBackground_101_1539}
            />
          </View>
        </View>
        <View style={styles.View_101_1547}>
          <Text style={styles.Text_101_1547}>Bill Pay</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_101_1548}>
        <View style={styles.View_101_1549}>
          <Text style={styles.Text_101_1549}>History</Text>
        </View>
        <View style={styles.View_101_1550}>
          <View style={styles.View_101_1551} />
          <View style={styles.View_101_1552}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1ea4/ef0a/c96c52bc099c1a072d4fbc09df6ccb01"
              }}
              style={styles.ImageBackground_101_1553}
            />
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I101_1397_101_10: {
    flexGrow: 1,
  ...
  ImageBackground_I101_1403_101_18: {
    flexGrow: 1,
