...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2740} />
      <View style={styles.View_101_2746} />
      <View style={styles.View_101_2747} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_2748}
      />
      <View style={styles.View_101_2749}>
        <View style={styles.View_101_2750}>
          <Text style={styles.Text_101_2750}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2751}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2756}
      />
      <View style={styles.View_101_2760}>
        <View style={styles.View_101_2761} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2762}
        />
        <View style={styles.View_101_2763} />
      </View>
      <View style={styles.View_101_2764}>
        <Text style={styles.Text_101_2764}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_2765} />
      <View style={styles.View_101_2766} />
      <View style={styles.View_101_2767}>
        <Text style={styles.Text_101_2767}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_2768}>
        <Text style={styles.Text_101_2768}>281-001066</Text>
      </View>
      <View style={styles.View_101_2769}>
        <Text style={styles.Text_101_2769}>Meter No.</Text>
      </View>
      <View style={styles.View_101_2770} />
      <View style={styles.View_101_2771}>
        <Text style={styles.Text_101_2771}>M-111009</Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2772}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2847"))
        }
      >
        <View style={styles.View_101_2773} />
        <View style={styles.View_101_2774}>
          <Text style={styles.Text_101_2774}>Next</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_101_2775}>
        <Text style={styles.Text_101_2775}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
