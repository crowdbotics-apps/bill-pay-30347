...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2994} />
      <View style={styles.View_101_3000} />
      <View style={styles.View_101_3001} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_3002}
      />
      <View style={styles.View_101_3003}>
        <View style={styles.View_101_3004}>
          <Text style={styles.Text_101_3004}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_3005}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3010}
      />
      <View style={styles.View_101_3014}>
        <View style={styles.View_101_3015} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_3016}
        />
        <View style={styles.View_101_3017} />
      </View>
      <View style={styles.View_101_3018}>
        <Text style={styles.Text_101_3018}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_3019} />
      <View style={styles.View_101_3020} />
      <View style={styles.View_101_3021}>
        <Text style={styles.Text_101_3021}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_3022}>
        <Text style={styles.Text_101_3022}>281-001066</Text>
      </View>
      <View style={styles.View_101_3023}>
        <Text style={styles.Text_101_3023}>Meter No.</Text>
      </View>
      <View style={styles.View_101_3024} />
      <View style={styles.View_101_3025}>
        <Text style={styles.Text_101_3025}>M-111009</Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_101_3026}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_3101"))
        }
      >
        <View style={styles.View_101_3027} />
        <View style={styles.View_101_3028}>
          <Text style={styles.Text_101_3028}>Next</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_101_3029}>
        <Text style={styles.Text_101_3029}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
