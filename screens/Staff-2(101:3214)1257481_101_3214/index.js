...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_3221} />
      <View style={styles.View_101_3222} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_3223}
      />
      <View style={styles.View_101_3224}>
        <View style={styles.View_101_3225}>
          <Text style={styles.Text_101_3225}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_3226}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3231}
      />
      <View style={styles.View_101_3235}>
        <View style={styles.View_101_3236} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_3237}
        />
        <View style={styles.View_101_3238} />
      </View>
      <View style={styles.View_101_3239}>
        <Text style={styles.Text_101_3239}>Bill Pay</Text>
      </View>
      <View style={styles.View_101_3240} />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_3241}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_3066"))
        }
      />
      <View style={styles.View_101_3242}>
        <Text style={styles.Text_101_3242}>Myanmar Net Postpaid Bill</Text>
      </View>
      <View style={styles.View_101_3243}>
        <Text style={styles.Text_101_3243}>Electricity Bill (Yangon)</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3244}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3245}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3246}
      />
    </ScrollView>
  )
}
