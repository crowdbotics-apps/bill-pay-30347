...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2813} />
      <View style={styles.View_101_2819} />
      <View style={styles.View_101_2820} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_2821}
      />
      <View style={styles.View_101_2822}>
        <View style={styles.View_101_2823}>
          <Text style={styles.Text_101_2823}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2824}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2829}
      />
      <View style={styles.View_101_2833}>
        <View style={styles.View_101_2834} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2835}
        />
        <View style={styles.View_101_2836} />
      </View>
      <View style={styles.View_101_2837}>
        <Text style={styles.Text_101_2837}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_2838} />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2839}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2776"))
        }
      />
      <View style={styles.View_101_2840}>
        <Text style={styles.Text_101_2840}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_2841}>
        <Text style={styles.Text_101_2841}>Meter No.</Text>
      </View>
      <View style={styles.View_101_2842} />
      <View style={styles.View_101_2843}>
        <View style={styles.View_101_2844} />
        <View style={styles.View_101_2845}>
          <Text style={styles.Text_101_2845}>Next</Text>
        </View>
      </View>
      <View style={styles.View_101_2846}>
        <Text style={styles.Text_101_2846}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
