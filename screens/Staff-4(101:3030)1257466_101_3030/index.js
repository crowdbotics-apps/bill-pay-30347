...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_3031} />
      <View style={styles.View_101_3037} />
      <View style={styles.View_101_3038} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_3039}
      />
      <View style={styles.View_101_3040}>
        <View style={styles.View_101_3041}>
          <Text style={styles.Text_101_3041}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_3042}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_3047}
      />
      <View style={styles.View_101_3051}>
        <View style={styles.View_101_3052} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_3053}
        />
        <View style={styles.View_101_3054} />
      </View>
      <View style={styles.View_101_3055}>
        <Text style={styles.Text_101_3055}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_3056} />
      <View style={styles.View_101_3057} />
      <View style={styles.View_101_3058}>
        <Text style={styles.Text_101_3058}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_3059}>
        <Text style={styles.Text_101_3059}>281-001066</Text>
      </View>
      <View style={styles.View_101_3060}>
        <Text style={styles.Text_101_3060}>Meter No.</Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_101_3061}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2993"))
        }
      />
      <View style={styles.View_101_3062}>
        <View style={styles.View_101_3063} />
        <View style={styles.View_101_3064}>
          <Text style={styles.Text_101_3064}>Next</Text>
        </View>
      </View>
      <View style={styles.View_101_3065}>
        <Text style={styles.Text_101_3065}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
