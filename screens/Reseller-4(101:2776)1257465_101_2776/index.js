...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2777} />
      <View style={styles.View_101_2783} />
      <View style={styles.View_101_2784} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_2785}
      />
      <View style={styles.View_101_2786}>
        <View style={styles.View_101_2787}>
          <Text style={styles.Text_101_2787}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2788}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2793}
      />
      <View style={styles.View_101_2797}>
        <View style={styles.View_101_2798} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2799}
        />
        <View style={styles.View_101_2800} />
      </View>
      <View style={styles.View_101_2801}>
        <Text style={styles.Text_101_2801}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_2802} />
      <View style={styles.View_101_2803} />
      <View style={styles.View_101_2804}>
        <Text style={styles.Text_101_2804}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_2805}>
        <Text style={styles.Text_101_2805}>281-001066</Text>
      </View>
      <View style={styles.View_101_2806}>
        <Text style={styles.Text_101_2806}>Meter No.</Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2807}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2739"))
        }
      />
      <View style={styles.View_101_2808}>
        <View style={styles.View_101_2809} />
        <View style={styles.View_101_2810}>
          <Text style={styles.Text_101_2810}>Next</Text>
        </View>
      </View>
      <View style={styles.View_101_2811}>
        <Text style={styles.Text_101_2811}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
