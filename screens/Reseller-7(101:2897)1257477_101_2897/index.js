...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2898} />
      <View style={styles.View_101_2904} />
      <View style={styles.View_101_2905} />
      <View style={styles.View_101_2906}>
        <View style={styles.View_101_2907}>
          <Text style={styles.Text_101_2907}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2908}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2913}
      />
      <View style={styles.View_101_2917}>
        <View style={styles.View_101_2918} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2919}
        />
        <View style={styles.View_101_2920} />
      </View>
      <View style={styles.View_101_2921}>
        <Text style={styles.Text_101_2921}>Pay</Text>
      </View>
      <View style={styles.View_101_2922} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3067/fa5e/c42bdb1e7918225d2966921409f315e8"
        }}
        style={styles.ImageBackground_101_2923}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2924}
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2925}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("111_206"))
        }
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2926}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("111_206"))
        }
      />
      <View style={styles.View_101_2927}>
        <Text style={styles.Text_101_2927}>09</Text>
      </View>
      <View style={styles.View_101_2928}>
        <Text style={styles.Text_101_2928}>Send</Text>
      </View>
      <View style={styles.View_101_2929}>
        <Text style={styles.Text_101_2929}>Send SMS Receipt</Text>
      </View>
      <View style={styles.View_101_2930}>
        <Text style={styles.Text_101_2930}>Successfully Paid!</Text>
      </View>
      <View style={styles.View_101_2931}>
        <Text style={styles.Text_101_2931}>36,400 Ks</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2932}
      />
      <View style={styles.View_101_2933}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5dfe/b844/4ab0df9065976d9bce2eeef761b388f1"
          }}
          style={styles.ImageBackground_101_2934}
        />
      </View>
      <View style={styles.View_101_2937}>
        <Text style={styles.Text_101_2937}>Bill Pay</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2938}
      />
      <View style={styles.View_101_2939}>
        <Text style={styles.Text_101_2939}>Service Month</Text>
      </View>
      <View style={styles.View_101_2940}>
        <Text style={styles.Text_101_2940}>March, 2020</Text>
      </View>
      <View style={styles.View_101_2941}>
        <Text style={styles.Text_101_2941}>Paid By</Text>
      </View>
      <View style={styles.View_101_2942}>
        <Text style={styles.Text_101_2942}>Tin Ko Ko Win</Text>
      </View>
      <View style={styles.View_101_2943}>
        <Text style={styles.Text_101_2943}>Date</Text>
      </View>
      <View style={styles.View_101_2944}>
        <Text style={styles.Text_101_2944}>2020-04-05</Text>
      </View>
      <View style={styles.View_101_2945}>
        <Text style={styles.Text_101_2945}>Barcode</Text>
      </View>
      <View style={styles.View_101_2946}>
        <Text style={styles.Text_101_2946}>Customer Name</Text>
      </View>
      <View style={styles.View_101_2947}>
        <Text style={styles.Text_101_2947}>Meter No.</Text>
      </View>
      <View style={styles.View_101_2948}>
        <Text style={styles.Text_101_2948}>281-001066</Text>
      </View>
      <View style={styles.View_101_2949}>
        <Text style={styles.Text_101_2949}>Su Su</Text>
      </View>
      <View style={styles.View_101_2950}>
        <Text style={styles.Text_101_2950}>M-111009</Text>
      </View>
      <View style={styles.View_101_2951}>
        <Text style={styles.Text_101_2951}>Bill Amount</Text>
      </View>
      <View style={styles.View_101_2952}>
        <Text style={styles.Text_101_2952}>Service Fees</Text>
      </View>
      <View style={styles.View_101_2953}>
        <Text style={styles.Text_101_2953}>36,200 Ks</Text>
      </View>
      <View style={styles.View_101_2954}>
        <Text style={styles.Text_101_2954}>200 Ks</Text>
      </View>
      <View style={styles.View_101_2955} />
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2956}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_1813"))
        }
      />
      <View style={styles.View_101_2957}>
        <Text style={styles.Text_101_2957}>Next Payment</Text>
      </View>
      <View style={styles.View_101_2958}>
        <Text style={styles.Text_101_2958}>Back to Home</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2959}
      />
    </ScrollView>
  )
}
