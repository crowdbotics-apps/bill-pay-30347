...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_101_2696} />
      <View style={styles.View_101_2702} />
      <View style={styles.View_101_2703} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7a4a/bb4c/b2082e4dc0965523643f9f80b22521a2"
        }}
        style={styles.ImageBackground_101_2704}
      />
      <View style={styles.View_101_2705}>
        <View style={styles.View_101_2706}>
          <Text style={styles.Text_101_2706}>12:30 PM</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_101_2707}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_101_2712}
      />
      <View style={styles.View_101_2716}>
        <View style={styles.View_101_2717} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
          }}
          style={styles.ImageBackground_101_2718}
        />
        <View style={styles.View_101_2719} />
      </View>
      <View style={styles.View_101_2720}>
        <Text style={styles.Text_101_2720}>Electricity Bill (Yangon)</Text>
      </View>
      <View style={styles.View_101_2721} />
      <View style={styles.View_101_2722} />
      <View style={styles.View_101_2723}>
        <Text style={styles.Text_101_2723}>Barcode/ CNP No.</Text>
      </View>
      <View style={styles.View_101_2724}>
        <Text style={styles.Text_101_2724}>281-001066</Text>
      </View>
      <View style={styles.View_101_2725}>
        <Text style={styles.Text_101_2725}>Meter No.</Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_101_2726}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("101_2111"))
        }
      />
      <View style={styles.View_101_2728}>
        <View style={styles.View_101_2729} />
        <View style={styles.View_101_2730}>
          <Text style={styles.Text_101_2730}>Next</Text>
        </View>
      </View>
      <View style={styles.View_101_2731}>
        <Text style={styles.Text_101_2731}>Need help?</Text>
      </View>
    </ScrollView>
  )
}
